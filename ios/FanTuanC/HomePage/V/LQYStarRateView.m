...
@implementation LQYStarRateView
...
#pragma mark -- 点击星星改变评分（项目不需要）注释了
...
- (void)layoutSubviews {
    ...
    __weak LQYStarRateView *weakSelf = self;
