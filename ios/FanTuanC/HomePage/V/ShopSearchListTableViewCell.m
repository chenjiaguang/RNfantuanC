...
#import "ShopSearchListTableViewCell.h"

@implementation ShopSearchListTableViewCell
{
...
- (void)createSubviews
{
    ...
    _avgpriceLabel = [[UILabel alloc] initWithFrame:CGRectMake(_myStarRateV.frame.size.width + _myStarRateV.frame.origin.x + 5, _myStarRateV.frame.origin.y, 80, 12)];
    ...
    _categoryLabel = [[UILabel alloc] initWithFrame:CGRectMake(_nameLabel.frame.origin.x, _myStarRateV.frame.origin.y + 12 + 9, _nameLabel.frame.size.width - 80, 12)];
    ...
    _floorLabel = [[UILabel alloc] initWithFrame:CGRectMake(kScreenW - 95, _categoryLabel.frame.origin.y, 80, 12)];
    _floorLabel.textColor = [MyTool colorWithString:@"333333"];
