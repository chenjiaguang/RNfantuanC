...
- (UIColor *)titleColor {
    if (!_titleColor) {
        _titleColor = [UIColor colorWithRed:65.0/255 green:65.0/255 blue:65.0/255 alpha:1];
    }
    return _titleColor;
}
...
- (UIColor *)titleSelectedColor {
    if (!_titleSelectedColor) {
        _titleSelectedColor = [UIColor colorWithRed:255.0/255 green:63.0/255 blue:83.0/255 alpha:1];
    }
...
- (UIColor *)indicatorColor {
    if (!_indicatorColor) {
        _indicatorColor = [UIColor colorWithRed:255.0/255 green:63.0/255 blue:83.0/255 alpha:1];
    }
