...
-(void)autoLayoutView
{
    ...
    .leftSpaceToView(self.contentView, 15)
    .topSpaceToView(_model.location.length > 0?_addressbnt:_contentLabel, 15)
    .heightIs(15)
    .widthIs(89);
...
-(void)createUI
{
    ...
    _lienView = lienView;
    [self.contentView sd_addSubviews:@[headImageView,nameLabel,adminIamgeView,timerLabel,contentLabel,praisebnt,commentsbnt,sourceLabel,sourcebnt,addressbnt,lienView]];
