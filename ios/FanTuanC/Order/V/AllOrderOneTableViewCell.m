...
#import "AllOrderOneTableViewCell.h"

@implementation AllOrderOneTableViewCell
...
{
    UIView *bgView = [[UIView alloc] initWithFrame:CGRectMake(0, 41, kScreenW, 161)];
    bgView.backgroundColor = [UIColor whiteColor];
    [self.contentView addSubview:bgView];
    
    if (![type isEqualToString:@"0"]) {
        bgView.frame = CGRectMake(0, 10, kScreenW, 161);
    } else {
    ...
    _timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, line.frame.origin.y + 1, kScreenW - 30, 44)];
    ...
    UILabel *line1 = [[UILabel alloc] initWithFrame:CGRectMake(15, _timeLabel.frame.origin.y + _timeLabel.frame.size.height, kScreenW - 30, 1)];
    line1.layer.backgroundColor = [MyTool colorWithString:@"e5e5e5"].CGColor;
    [bgView addSubview:line1];
    
    
    _memoyLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, line1.frame.origin.y + 1, 200, 161 - line1.frame.origin.y - 1)];
